"""
Django settings for Stock Breakout Alert System.
"""
...
# Database - uses DATABASE_URL in production, SQLite in development
DATABASES = {
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'Stock Alerts <alerts@stockapp.local>')
...
# ATR Analysis Settings
ATR_PERIOD = 14
CONSOLIDATION_THRESHOLD_DAYS = 3
